...
| Talk | Venue | Date |
|---|---|---|
| **[raylib, driven from Lisp](https://www.02ship.com/blog/02ship-sydney-meetup-august-11-recap)**<br/><sub>Open-mic demo of raylib — a C game library — driven from [Jolt](https://github.com/jolt-lang/jolt), native Clojure on Chez Scheme, plus the screen-capture and UI-automation tooling built to record demo GIFs instead of testing by hand. That suite is now [b12n-raylib-jlt](https://github.com/burinc/b12n-raylib-jlt); the [jank](https://github.com/burinc/b12n-raylib-jnk) and [JVM](https://github.com/burinc/b12n-raylib-clj) siblings followed, all open source.</sub> | 02Ship Sydney Meetup<br/><sub>Level 2, 63 Dixon St, Haymarket</sub> | Aug 2026 |
