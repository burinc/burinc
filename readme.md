...
| **Spring Boot Real-Time Debugging from the Clojure REPL**<br/><sub>Live Java debugging via a Clojure REPL attached to Spring Boot — modify and recompile running code without a restart.</sub> | Sydney Java Meetup | Mar 2025 |
