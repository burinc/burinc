...
| Talk | Venue | Date |
|---|---|---|
| **[raylib, driven from Lisp](https://www.02ship.com/blog/02ship-sydney-meetup-august-11-recap)**<br/><sub>Open-mic demo of raylib — a C game library — driven from Lisp: the [Jolt](https://github.com/jolt-lang/jolt) suite (native Clojure on Chez Scheme), a quick look at the JVM one, and the screen-capture and UI-automation tooling built to record demo GIFs instead of testing by hand. Those two are now [b12n-raylib-jlt](https://github.com/burinc/b12n-raylib-jlt) and [b12n-raylib-clj](https://github.com/burinc/b12n-raylib-clj); a [jank](https://github.com/burinc/b12n-raylib-jnk) sibling started the day after this meetup. The capture tooling is still unreleased.</sub> | 02Ship Sydney Meetup<br/><sub>Level 2, 63 Dixon St, Haymarket</sub> | Aug 2026 |
